...
Here $Q(z) = 1 - \frac{2}{3}z + \frac{1}{6}z^2$ which has roots at $z = 2 \pm i\sqrt{2}$ which both have positive real parts so condition A is satisfied. 
...
- An IRK method is A-stable if the roots of the denomintor have positive real parts and $E(y) = Q(iy)Q(-iy) - P(iy)P(-iy) \geq 0$