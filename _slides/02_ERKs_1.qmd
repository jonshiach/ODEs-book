...
:::{.fragment}
<span style="color:red">An Ordinary Differential Equation which is an equation expressed in terms of an independent variable, a function of the independent variable and derivatives of that function.</span>
:::

2. What three things a required for an IVP?

:::{.fragment}
<span style="color:red">An initial value problem requires an ODE, a range for the value of the independent variable and the initial values of the solution.</span>
:::

3. What are the local and global truncation errors of a method?

:::{.fragment}
<span style="color:red">The local truncation error is the error accrued over one step of a method assuming the previous step was exact.</span>

<span style="color:red">The global truncation error is the accumulation of the local truncation errors.</span>
:::

4. What does it mean when we say the error of a method is $O(h^n)$?

:::{.fragment}
<span style="color:red">As the step length $h$ tends to zero, the value of the error will tend to zero at least as fast as $h^n$.</span>
:::
