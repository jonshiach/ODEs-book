...
- The **order** of a rooted tree $\tau$, denoted by $r(\tau)$, is the total number of nodes in the tree. $\tau$ is the Greek letter *tau* which is similer to the Latin letter *t*
